...
<td>
<a class="btn btn-delete" href="deletePlace?id=<%= rs.getInt("id") %>">Delete</a>
</td>
</tr>
<%
    }
        ...
        <div class="scroll-table">
            <table>
                ...
                <tr>
                    ...
                    <td><%= rs.getDate("donated_at") %></td>
                    <td title="<%= rs.getString("place_name") %>"><%= rs.getString("place_name") %></td>
        ...
        <div class="scroll-table">
            <table>
                ...
                <tr>
                    ...
                    <td title="<%= rs.getString("place_name") %>"><%= rs.getString("place_name") %></td>
                    <td>
                        <a class="btn btn-approve" href="approveDonation?id=<%= rs.getInt("id") %>">Approve</a>
                        <a class="btn btn-reject" href="rejectDonation?id=<%= rs.getInt("id") %>">Reject</a>
                        <a class="btn btn-delete" href="deleteDonation?id=<%= rs.getInt("id") %>">Delete</a>
                    </td>
                </tr>
                <%
                        }
